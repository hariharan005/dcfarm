...
const productsData = {
  ...
  Millets: [
    { id: 43, name: "Ragi", price: 70, unit: "kg", image: "https://via.placeholder.com/150" }, 
    { id: 44, name: "Foxtail Millet", price: 85, unit: "kg", image: "https://via.placeholder.com/150" },
    { id: 45, name: "Ellu", price: 85, unit: "kg", image: "https://via.placeholder.com/150" },
    { id: 46, name: "Corn", price: 85, unit: "kg", image: "https://via.placeholder.com/150" },
    { id: 47, name: "Drychilli", price: 85, unit: "kg", image: "https://via.placeholder.com/150" },
    { id: 48, name: "Pachai Payaru", price: 85, unit: "kg", image: "https://via.placeholder.com/150" },
    { id: 49, name: "Kambu", price: 85, unit: "kg", image: "https://via.placeholder.com/150" },
    { id: 50, name: "Thinai", price: 85, unit: "kg", image: "https://via.placeholder.com/150" },
    { id: 51, name: "Varagu", price: 85, unit: "kg", image: "https://via.placeholder.com/150" },
    { id: 52, name: "Samai", price: 85, unit: "kg", image: "https://via.placeholder.com/150" },
    { id: 53, name: "Kuthiraivali", price: 85, unit: "kg", image: "https://via.placeholder.com/150" },  
    { id: 54, name: "Ullundhu Black", price: 85, unit: "kg", image: "https://via.placeholder.com/150" },  
    { id: 55, name: "Ullundhu White", price: 85, unit: "kg", image: "https://via.placeholder.com/150" },
  ], 
  DairyProducts: [
    { id: 56, name: "Milk", price: 50, unit: "litre", image: "https://via.placeholder.com/150" }, 
    { id: 57, name: "Curd", price: 60, unit: "kg", image: "https://via.placeholder.com/150" },
    { id: 58, name: "Butter", price: 250, unit: "kg", image: "https://via.placeholder.com/150" },
    { id: 59, name: "Ghee", price: 230, unit: "kg", image: "https://via.placeholder.com/150" },
    { id: 60, name: "Paneer", price: 300, unit: "kg", image: "https://via.placeholder.com/150" },
    { id: 61, name: "Cheese", price: 200, unit: "kg", image: "https://via.placeholder.com/150" },
    { id: 62, name: "ButterMilk", price: 150, unit: "litre", image: "https://via.placeholder.com/150" },
  ], 
  Eggs: [
    { id: 63, name: "NattuKozhi", price: 15, unit: "Piece", image: "https://via.placeholder.com/150" }, 
    { id: 64, name: "Duck", price: 20, unit: "Piece", image: "https://via.placeholder.com/150" },
  ], 
  Oils: [
    { id: 65, name: "Coconut Oil", price: 250, unit: "litre", image: "https://via.placeholder.com/150" }, 
    { id: 66, name: "Groundnut Oil", price: 230, unit: "litre", image: "https://via.placeholder.com/150" },
    { id: 67, name: "Sesame Oil", price: 300, unit: "litre", image: "https://via.placeholder.com/150" },
    { id: 68, name: "Sunflower Oil", price: 200, unit: "litre", image: "https://via.placeholder.com/150" },
  ],
};
